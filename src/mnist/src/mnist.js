...
console.log(fetch("./digits/0.json"));
// raw data
var raw = [
  fetch("./digits/0.json").data,
  fetch("./digits/1.json").data,
  fetch("./digits/2.json").data,
  fetch("./digits/3.json").data,
  fetch("./digits/4.json").data,
  fetch("./digits/5.json").data,
  fetch("./digits/6.json").data,
  fetch("./digits/7.json").data,
  fetch("./digits/8.json").data,
  fetch("./digits/9.json").data,
];
